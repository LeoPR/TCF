...
| [T-CODE-ENCODER-MANAGER](T-CODE-ENCODER-MANAGER.md) | Revive D13 v0.4: paralelismo `_encode_column` em workers, sinks (file/multi-file/HTTP/TCP), per-channel headers (O-FMT-13), streaming chunked (O-FMT-08). Plano 4 fases. | **OPEN P2 2026-05-24** |
