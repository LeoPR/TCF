...
| [BUG-BB-CR-CRU](BUG-BB-CR-CRU.md) | a união bool+str `#TCF.8bB` aceita CR em um extra e grava byte `0d` cru, embora o wire seja LF-only; controles single string/multi recusam e `.8H` escapa. | **OPEN P2 2026-08-29** |
| [BUG-MENSAGEM-COLUNA-VAZIA-MISTA](BUG-MENSAGEM-COLUNA-VAZIA-MISTA.md) | o fail-loud de tipo misto nomeia colunas comuns, mas omite o nome válido `''` por truthiness; o controle homogêneo com a mesma chave faz RT. | **OPEN P3 2026-08-29** |
