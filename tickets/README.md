...
| [T-SPEC-STATUS-08](T-SPEC-STATUS-08.md) | **[dispositivo→registro]** Status dos specs (survey 3-agentes 2026-07-12) pra decidir o que fecha antes do teste em massa. Abordagem 1 (linguagem generalista/specs-induzidas) = mapeada, gated .9. Abordagem 2 (clássicos BR): ACHADO = gargalo é DADO, não máquina — `check_fn` é param LIVRE do construtor (5/7 clássicos cabem sem tocar core; CEP/PIS/renavam/título/CNH via construtor; telefone/RG/placa precisam máquina nova); mas só CNPJ (receita real) fecha o gate ≥15%/2-reais; CPF synthetic-teto. Decisão pendente A/B/C. | **OPEN P1 2026-07-12** |
