...
| [T-CODE-ENCODER-MANAGER](T-CODE-ENCODER-MANAGER.md) | **Fase 1 WELDED**: `encode(data, parallel=False\|True\|N)` via ProcessPoolExecutor, `_worker_encode_column` picklavel, 14/14 tests, D17a 322B INVARIANT preservado, byte-canonical em parallel. Benchmark: customer 0.79x, orders 1.23x (speedup modesto por load imbalance + pickling Windows spawn — otimizacao Fase 1b). Fases 2-4 pendentes. | **OPEN-FASE-1-WELDED 2026-05-24** |
