...
| [T-CODE-EMPTY-FRAG-INDEX-RT](T-CODE-EMPTY-FRAG-INDEX-RT.md) | **[probatório] Bug de RT no core M10**: string vazia desloca o index de fragmento HCC → back-ref posterior corrompe/crasha (`['','AAAB','AAAC']`→`['','AAAB','BC']`; `['','RES','RESID']`→KeyError). Viola `decode(encode(x))==x` em dado trivial-real (achado na caracterizacao V2-A, receita nome_fantasia). Fix exige aprovacao (toca src/tcf) + gate D1-D9=1523B + real-world. | **OPEN P1 2026-06-13** |
