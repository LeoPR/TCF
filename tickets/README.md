...
| [T-QA-8](T-QA-8-material-comprobatorio.md) | **[dispositivo→exec]** Material comprobatório do #TCF.8/0.8.0. F0 (12/13 achados originais), F1 runner e F2 controle concluídos; 600 passed. BUG-14 (RT Unicode no domínio aceito) é gate R0; depois F3→F4→F5 condicional→F6. | **CLOSED 2026-09-15 · dossiê do `.8`** |
...
| [T-QA-8-material-comprobatorio](T-QA-8-material-comprobatorio.md) | material comprobatório do #TCF.8/0.8.0 (controle → sintéticos → públicos) com telemetria, dicts | closed |
