...
| [T-CI-3-pyx-compiled-byte-gate](T-CI-3-pyx-compiled-byte-gate.md) | Gate byte-canonical do caminho Cython COMPILADO: suíte só valida pure-Python (accel=False); ADR-0020 exige byte-equivalência .py↔.pyx mas nunca testa o `.pyd`. Achado na caracterização do P4. | **OPEN 2026-06-24** |
