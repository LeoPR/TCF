...
| [T-STORAGE-ECOSSISTEMA-09](T-STORAGE-ECOSSISTEMA-09.md) | **2o eixo do `.9`** (o `.9` NAO e' so' perf): rodar em HDFS/Parquet/object store — compor com a compressao do container (ha' caso MEDIDO de PIORA: -41% em texto livre denso), leitura por range usando o meta como indice, e blocos (esbarra no concat que corrompe calado) | **OPEN P1 (.9)** |
