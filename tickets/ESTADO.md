...
| [T-CODE-TCF8H-JSON-PARITY](T-CODE-TCF8H-JSON-PARITY.md) | `P1` open | 2026-07-17 | o que falta pra fechar "hierarquia" (paridade JSON) + 1 capacidade exclusiva |
| [T-CODE-TCF8H-WELD](T-CODE-TCF8H-WELD.md) | `P1` open | 2026-07-13 | weld do codec hierárquico #TCF.8H no src/tcf (feature do .8) |
...
| [T-QA-8-material-comprobatorio](T-QA-8-material-comprobatorio.md) | `P1` open | 2026-07-12 | T-QA-8, material comprobatório do #TCF.8/0.8.0 (controle → sintéticos → públicos) com telemetria |
...
| [T-CODE-VIEW-SUBTCF-RECORTE](T-CODE-VIEW-SUBTCF-RECORTE.md) | `P2` open | 2026-08-26 | promover H-QUERY-06 a saída TCF da view |
...
| [T-FMT-CONTRACT-SIGNATURE](T-FMT-CONTRACT-SIGNATURE.md) | `P2` open | 2026-08-20 | assinatura de contrato para os knobs que não reconstroem a entrada (drop_names, sort_by) |
...
| [T-STUDY-USE-PROFILES](T-STUDY-USE-PROFILES.md) | `P3` open | 2026-08-20 | perfis de uso (transmissão × armazenamento) e a calibração dos vértices |
