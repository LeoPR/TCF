...
|---|---|---|
| `{}` objeto (1:1), aninhado | ✅ coberto | n/a |
| `[]` array de objetos/escalares (1:N) + `#count` | ✅ coberto | n/a |
| string (incl. unicode, separadores) | ✅ coberto | n/a |
| nome de chave c/ char do meta | ✅ **escaping welded** (`40a7e10`) | **congelar** contrato |
| aninhamento arbitrário (contenção) | ✅ classe coberta | n/a |
...
| **`null` na raiz** | ✅ **WELDED 2026-07-17** (P4b: `#V` envelope) | n/a |
...
| ✅ paridade JÁ medida (2026-07-17) | `\t` · `\x00` em valor · int gigante `10**30` · `-0.0` · `0.1+0.2` (precisão), **idênticos ao json** | n/a |
