...
related:
  ...
  - `reference_strata_knowledge_architecture_review.md` (memória do agente, fora do repo)
  - `feedback_strata_l0_check_before_big_changes.md` (memória do agente, fora do repo)
---
