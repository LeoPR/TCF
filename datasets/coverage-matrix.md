...
| **br-identidades/empresas** | check-digit CNPJ + estruturado | S · M · L | download-bulk | não | n/a |
| **tpch-lineitem** | estruturado+free-text (16c) | S · M · L · **XL** | download-bulk | sim | ✓ |
| **tpch orders/customer/part…** | estruturado (star/chain) | S · M · L | download-bulk **+ arquitetura** (join/FK) | não | n/a |
| **beijing-pm25** | série temporal sensor | S · M (~44k) | **download-cadenced** ⚠ ts SPLIT em int → **G3** | não | n/a |
| **wine-quality** | float científico (12c) | S (~6.5k) | download-bulk | não | n/a |
| **D1-D17** † | por tipo, single-col, 12-20 linhas | **µ** | probes de tipo (não payload) | parcial | n/a |
