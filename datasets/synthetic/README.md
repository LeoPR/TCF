...
| D11d-datetime-min.csv | Datetime YYYY-MM-DD HH:MM:SS, heartbeat top-of-minute | 13 | 264 | Granularity=second, cadencia minuto — testa escala `+1m` | [T01-incremental sub 06](../../experiments/lab/dirty/2026-05-15-naturezas-e-camada/pre-tx/T01-incremental-base-delta/06-staged-granularity-second/) |
| D11e-datetime-mensal.csv | Datetime YYYY-MM-DD HH:MM:SS, fatura mensal dia 5 às 9h | 13 | 264 | Granularity=second, cadencia mensal — demo escala `+1M` em datetime (ganho 57% C vs B) | [T01-incremental sub 07](../../experiments/lab/dirty/2026-05-15-naturezas-e-camada/pre-tx/T01-incremental-base-delta/07-cadencia-mensal-datetime-D11e/) |
