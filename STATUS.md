...
| [ADR-0023 (welded direto)](docs/adr/0023-v2-minimal-header-weld.md) | **CLOSED-WELDED 2026-06-14** | **Header v2 minimo** (O-FMT-15+16): opt-in `encode(table, min_header=True)`; mantem `#`, tira o espaco, omite o size da ULTIMA coluna (corpo ate' EOF); emite `#TCF.7 M`. Compoe com fallback. Default OFF preserva byte-canonical. Cadastro README 182->178B. 351 passed. Foco: payload minusculo (memoria project-byte-level-compression-focus). |
