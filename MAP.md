...
| **EXP-017 — alvos mensais de data em corpus REAL** (clean, probatório: 26 casos, 5 provas, PINs fixados) | `experiments/lab/clean/EXP-017-data-alvos-mensais/` — **NÃO fecha em dado real (0,0%) contra 95% no sintético**, porque **nenhuma das 10 colunas reais tem cadência mensal**; e o método corrigido expôs o achado maior: o candidato da nature soldada **não passa pela rota plena** (sem polaridade, sem bN) = **mediana 6,7% desperdiçado** em dado real, geral a QUALQUER nature (CPF 7,0%) |
