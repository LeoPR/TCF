...
| **Divulgacao**: material pra apresentar o projeto. Fonte de noticia datada + textos por canal; as regras editoriais e os limites de cada canal ficam no README da pasta | `docs/divulgacao/` |
