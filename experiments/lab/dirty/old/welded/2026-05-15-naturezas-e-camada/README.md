...
**Estado**: ARQUIVADO (faxina 2026-06-21) — `superseded`. Só o macro T01 rodou; foi
ABSORVIDO no Pacote 1 Delta-aware welded (ADR-0008/0010/0011). Lab que o superou:
[`../2026-05-17-OBAT-delta-aware/`](../2026-05-17-OBAT-delta-aware/). Links internos
profundos do nest T01 não foram re-baseados no move (dev-efêmero; git preserva).
