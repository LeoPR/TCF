...
"""H-PERF-06-v2 Fase B — porte Cython de _detect_compositions (typed locals).

Logica IDENTICA ao src/tcf/composicional/syntax.py (pos-weld #15). Estruturas
de dados continuam Python (Counter/dict/tuple/list) -> ordem de insercao e
tie-break first-wins preservados byte-exato. So' adiciona cdef Py_ssize_t em
contadores/comprimentos e cdef list nas listas quentes. Genexprs renomeadas
(j/y) pra evitar clash de escopo com os cdef.

Byte-canonical validado por D1-D9 + D17a + 3 fixtures real-world.
"""
