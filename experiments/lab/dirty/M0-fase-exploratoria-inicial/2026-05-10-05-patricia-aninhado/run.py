"""Roda 4 datasets didaticos, valida roundtrip, imprime TCF aninhado.

Para cada cenario:
  - constroi arvore Patricia (mesmo algoritmo dos exps 02/03/04)
  - encoda em aninhado (este experimento)
  - decodifica e valida roundtrip
  - mostra a arvore + o TCF inteiro
"""
