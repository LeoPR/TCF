...
**Data**: 2026-06-27. Valida o [design-b2.md](../../2026-06-21/2026-06-21-gdict-caracterizacao/design-b2.md)
...
- Dados reais: `Z:/tcf-data/external/` (SNAP, OpenFlights) — ver [B1 provenance](../../2026-06-21/2026-06-21-gdict-caracterizacao/datasets-provenance.md).

## Rodar
```bash
python experiments/lab/dirty/2026-06/2026-06-27/2026-06-27-gdict-b2-prototype/run.py
```
