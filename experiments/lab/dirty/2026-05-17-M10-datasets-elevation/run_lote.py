"""run_lote.py — M10 (datasets-elevation).

Smoke test do fluxo: roda M8.A apontando para `datasets/synthetic/`
(localizacao canonica oficial) em vez de `./data/` local. Esperado:
bytes byte-a-byte identicos a M9.
"""
...
# Path canonico para datasets sinteticos (elevados de M9).
# experiments/lab/dirty/<M10>/run_lote.py → 3 niveis acima = project root
