...
não conflite com os dados". **Pré-requisito conceitual do [H-GDICT-01](../2026-05/roadmap-hipoteses.md)** (dict
...
o dedup cross-column ([H-GDICT-01](../2026-05/roadmap-hipoteses.md)). *Trade:* espaço de ID maior (índice mais
...
> `bN` (largura de bits pura, não base-94) — ver [`tipos-como-specs.md`](../2026-07/tipos-como-specs.md) e
> [H-TYPE-02](../2026-05/roadmap-hipoteses.md). Resultado: o caveat **se confirma** — ganho pré-brotli de 2×-8× cai
...
> Origem: [audit de primitivas](../2026-07/primitivas-consolidacao-audit.md) — o owner notou que mecanismos com nomes
...
6. **Duas perspectivas do bN** (owner 2026-07-08, H-TYPE-07): (a) REATIVA — `@dict`-index bit-packed,
   ...
   [`bn-dict-perspectivas-e-dict-interno.md`](../2026-07/bn-dict-perspectivas-e-dict-interno.md).
...
- **Payoff**: [H-GDICT-01 (dict global/cross-column)](../2026-05/roadmap-hipoteses.md) (Pacote 11-ter).
- **Famílias vizinhas**: [estudo RLE × DICT](rle-familia-estudo.md); H-INTRA (intra-valor,
  [Pacote 11](../2026-05/roadmap-hipoteses.md#pacote-11)); V2-RLE-STREAM
...
- **Formato futuro**: [futuras-otimizacoes-formato.md](../2026-05/futuras-otimizacoes-formato.md) (O-FMT-06/07
