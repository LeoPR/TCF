...
- **(D3) dict GLOBAL/cross-column no header** — 1 tabela compartilhada entre colunas. **= a ideia do
  owner** ([H-GDICT-01](../2026-05/roadmap-hipoteses.md), = O-FMT-06/07). **NÃO testado.**
...
| **B** | V2-RLE-STREAM — RLE no stream de índices do V2-B (`@dict`) | **intra-stream**: índice inteiro adjacente | **caracterizado** → CLOSED-geral / nicho aberto (probatório) | lab [result.md](../../old/refuted/2026-06-19-v2rle-stream-caracterizacao/result.md); registry [Pacote 11-bis](../2026-05/roadmap-hipoteses.md); depende de [ADR-0025 V2-B](../../../../../docs/adr/0025-v2b-dictionary-categorical-weld.md) |
| **C** | RLE intra-valor (H-INTRA-01/02/03 / O-FMT-17) | **intra-valor**: substring dentro de uma célula | **ADIADO** (aberta, alvo 0.8) | registry [Pacote 11](../2026-05/roadmap-hipoteses.md#pacote-11); [O-FMT-17](../2026-05/futuras-otimizacoes-formato.md) |
...
[H-INTRA-03](../2026-05/roadmap-hipoteses.md#pacote-11) já exige medir o **INCREMENTO** de C sobre
...
Distinto de [H-CODEBOOK-01](../2026-05/roadmap-hipoteses.md) (dict **externo**/versionado; D3 é **interno** ao blob).
...
- Registry: [roadmap-hipoteses.md](../2026-05/roadmap-hipoteses.md) — Pacote 11-bis (B = H-V2RLE-01/02),
  [Pacote 11](../2026-05/roadmap-hipoteses.md#pacote-11) (C = H-INTRA-01/02/03).
- Formato futuro: [futuras-otimizacoes-formato.md](../2026-05/futuras-otimizacoes-formato.md) (O-FMT-17).
