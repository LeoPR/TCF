...
| H-15-08 | Assimetria do LF final entre rotas (7 emitem, 3 nao) | **PRECIFICADO 2026-08-21, e a decisao foi NAO FAZER** (ADR-0045 §3): uniformizar exigiria mudar o DECODER em multi-col e tipado-bool (hoje REJEITAM o LF extra), mudaria SEMANTICA em multi-col n=1 (ganha valor vazio), e quebraria o gate D17a (300->301). Ganho: consistencia estetica e **-1 B por wire**. Fica conhecida e precificada, nao pendencia vaga — so' reabrir se houver motivo novo | ADR-0045 · lab `0400` |
