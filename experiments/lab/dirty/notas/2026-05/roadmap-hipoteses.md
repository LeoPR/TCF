...
| H-13-06 | **REFORMULADA 2026-08-17**: a composicao grupo x array e' ORTOGONAL — `count`, `emask` e mascara de campo ficam BYTE-IDENTICOS; so' a coluna de ITENS vira N colunas | aberta, com PLANO escrito | A premissa antiga ("os N campos precisam compartilhar a contagem") estava ERRADA: a sondagem mostra que a contagem e' de nivel de ARRAY e os itens de nivel de ITEM (`v#:6[` = count + coluna de itens ja' achatada). Plano com 10 casos (A1-A10) e 5 criterios de falsificacao: `notas/2026-08/2026-08-17-2000-plano-grupo-x-array.md` |
