...
| H-13-13 | **LACUNA NOVA (2026-08-17)**: `drop_names` NAO carrega assinatura de contrato — o decode devolve posicional e nao tem como FALHAR ALTO se a ponta tiver o contrato errado. E' convencao, nao contrato (classe SEMANTICA do `contrato-externalizado` §3.1). A `nature` ja' faz certo (`:cpf` = assinatura, `decoder.py:62-79`) | aberta | achada ao preparar o H-13-03; e' PRE-REQUISITO do S3/H-13-04 e vale ticket proprio |
