...
| **H-DICT-HIGHCARD** (o PIVÔ — achado robusto) | ⭐ 🔬 PROMOVIDA (4/5 reais) | dict per-col SEM cap (`_V2B_MAX_CARD=1024`) vence OBAT/HCC em **−16..−36%** em TODA categórica high-card alta-repetição (SNAP/OF/cit-HepTh/email-Enron); sobrevive gzip; ORTOGONAL e MAIOR que o cross-dict. Rever gating do V2-B por **N/K**, não só K. Ticket próprio; caracterizar + gate |
