...
| **H-TYPE-02** | Família `bN` (b1/b2/b4: k≤2/4/16 → 1/2/4 bits, domínio embutido = referência; nomenclatura resolvida 2026-07-08, w=8 fora) empacota enum/bool de baixa cardinalidade contra o baseline correto **V2-B** (ADR-0025, já weldado). | **bifurcada pós-gate D3 (2026-07-08, N=8)** — terminal `confirmada-empírica` (8.8% weighted; w≤4 honesto = 5.9%, F3) / re-comprimido `refutada-real-world` (1.7%, colapsa). Status vivo: [roadmap](../2026-05/roadmap-hipoteses.md) — esta tabela não duplica mais |
...
**Protótipo do (i)**: [2026-07-07-2138-bn-candidato-min-prototipo](../../2026-07/2026-07-07/2026-07-07-2138-bn-candidato-min-prototipo/result.md)
...
`aberta`, ver depois. (H-TYPE-05 no [roadmap](../2026-05/roadmap-hipoteses.md).)

**Cross-links**: [tipos-como-specs.md](tipos-como-specs.md) · [roadmap H-TYPE-*](../2026-05/roadmap-hipoteses.md) ·
