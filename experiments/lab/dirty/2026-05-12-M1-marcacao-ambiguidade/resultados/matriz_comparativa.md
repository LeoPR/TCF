...
|---|---|---|---|---|---|---|---|
| D1-emails-simples | 162 | 162 | 162 | 149 | 149 | M1-E-range | 13 (8.0%) |
| D2-emails-quote-id | 200 | 197 | 198 | 180 | 180 | M1-E-range | 20 (10.0%) |
| D3-stress-substring | 242 | 233 | 233 | 206 | 206 | M1-E-range | 36 (14.9%) |
| D4-caos-mix | 152 | 152 | 160 | 141 | 141 | M1-E-range | 19 (11.9%) |
| **TOTAL** | **756** | **744** | **753** | **676** | **676** | **M1-E-range** | 80 |

## Roundtrip por sintaxe × dataset

| dataset | M1-A-escape | M1-A-escape-escopo | M1-B-quote | M1-E-range | M1-C-sumida |
|---|---|---|---|---|---|
| D1-emails-simples | OK | OK | OK | OK | OK |
| D2-emails-quote-id | OK | OK | OK | OK | OK |
| D3-stress-substring | OK | OK | OK | OK | OK |
| D4-caos-mix | OK | OK | OK | OK | OK |
