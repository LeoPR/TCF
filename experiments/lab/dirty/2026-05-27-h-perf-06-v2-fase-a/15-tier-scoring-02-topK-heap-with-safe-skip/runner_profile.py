"""H-PERF-06-v2 Fase A — Candidate 15 tier-scoring-02-topK-heap-with-safe-skip
cProfile profile runner.

Espelha 00-baseline/runner.py mas com monkey-patch de _detect_compositions
aplicado ANTES do encode (igual a runner_regression.py).

Steps:
1. Carrega syntax_variant.py via importlib.util.
2. Monkey-patches tcf.composicional.syntax.M8AVirtualRefsSyntax._detect_compositions.
...
spec = importlib.util.spec_from_file_location(
    "syntax_variant_15_tier_scoring_02", str(VARIANT_PATH))
