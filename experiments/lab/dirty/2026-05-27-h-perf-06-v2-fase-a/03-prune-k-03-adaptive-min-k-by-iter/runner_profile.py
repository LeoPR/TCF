"""H-PERF-06-v2 prune-k-03 — variant cProfile do encode TCF.
...
`syntax_variant.py` deste sub-exp (adaptive min_k per iter).
...
def load_variant_detect():
    ...
    spec = importlib.util.spec_from_file_location(
        "syntax_variant_prune_k03_profile", str(variant_path))
