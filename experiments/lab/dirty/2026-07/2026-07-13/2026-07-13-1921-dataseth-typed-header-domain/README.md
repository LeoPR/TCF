...
**Plano**: [DatasetH - hierarquia completa e escalares especiais](../../../notas/2026-07/dataseth-hierarquia-completa-plano.md).
...
```powershell
python experiments/lab/dirty/2026-07/2026-07-13/2026-07-13-1921-dataseth-typed-header-domain/run.py
```
