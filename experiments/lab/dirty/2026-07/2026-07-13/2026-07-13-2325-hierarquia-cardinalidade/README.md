...
([teoria-cardinalidade](../../../notas/2026-07/teoria-cardinalidade.md)). **SEM tipos/nulos** (ortogonal, depois).
...
```powershell
python experiments/lab/dirty/2026-07/2026-07-13/2026-07-13-2325-hierarquia-cardinalidade/run.py
```
