...
**Plano**: [dataseth-hierarquia-completa-plano.md](../../../notas/2026-07/dataseth-hierarquia-completa-plano.md) (P4).
...
```powershell
python experiments/lab/dirty/2026-07/2026-07-13/2026-07-13-1955-dataseth-regular-def-levels/run.py
```
