...
**Hipóteses**: `H-DATASETH-COMPLETE-01`, `H-HIER-LINK-ALGEBRA-01` e `H-HIER-BOUNDARY-EMPTY-01` em [roadmap-hipoteses.md](../../../notas/2026-05/roadmap-hipoteses.md).
...
```powershell
python experiments/lab/dirty/2026-07/2026-07-16/2026-07-16-1708-dataseth-s0-s3-semantica-vinculos/run.py
```
