...
Welded from dirty lab `04-obat-shape-consistency-hint/obat_fork.py`.
Apenas cleanup (sem mudancas algoritmicas).
...
Atualizado 2026-05-19: adaptado pra nova assinatura indexed de
`_escolher_par` (ADR-0009). Mantem byte-canonical.
