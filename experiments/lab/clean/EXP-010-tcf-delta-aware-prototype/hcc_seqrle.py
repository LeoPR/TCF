"""HCC com seq-RLE de linhas near-identical.

Welded from dirty lab `02-hcc-sozinho-rle-near-identical/hcc_fork.py`
...
class HCCSeqRLE(M8AVirtualRefsSyntax):
    """HCC com seq-RLE no body via post-process."""
