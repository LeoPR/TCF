<!-- Versao do artigo preparada para o editor de artigos do LinkedIn.
     Gerada por scripts/make_divulgacao_figuras.py a partir de artigo.en.md.
     ...
     Como colar:
       1. Capa: figuras/en/0-capa.png, no quadro do topo (e' 1.91:1).
       ...
       4. Onde aparecer [IMAGEM: ...], use o botao de imagem, suba o arquivo de
          figuras/en/ e escreva a legenda indicada. Depois apague a linha do marcador.
-->
