...
de canal muda sem esta fonte mudar antes. Nada aqui é estimativa, e todo tamanho passou por
roundtrip validado antes de ser escrito, conforme a regra §RT do projeto.

Reproduz tudo em uma linha:
...
wire = encode(tabela)          # 242 B, o cadastro de 4 registros abaixo
...
v.column_bytes('cpf')          # 59 B de 193 B: dá para saber o custo por coluna
```

Nenhuma dessas chamadas decodifica a tabela inteira.
