...
**Configuração experimental (M-series, 2026-04):**
...
### A1 — TCF como schema carrier: hipótese confirmada (H-TCF2)
...
### A2 — Fewshot é obrigatório; sem ele o sistema falha por completo
...
### A3 — TCF ≈ JSON > CSV para geração de SQL (diferença pequena, mas robusta)
...
### A4 — SQL >> Pandas >> Polars para execução via LLM
...
### A5 — HAVING = falha universal em aggregação de dois níveis (7%)
...
### A6 — Generalização cross-domain confirmada (F-Q16)
