...
| **`view(...)` · `LazyTCF` · `Filtered`** | consulta lazy read-only: `#TCF.8M`, `#TCF.8H` retangular (nulo denso incluso), a rota de coluna única e o órfão (ver [`lazy-view.md`](lazy-view.md) e [`view-usos.md`](view-usos.md)). |
