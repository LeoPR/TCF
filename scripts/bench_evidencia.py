...
- Régua: `--validate-pins` confere o runner contra os 3 pinos da suíte
  (D1-D9=1545B, D17a=300B, real-world=89430B) — divergiu, é bug DO RUNNER
...
PIN_D1_D9_TOTAL = 1545      # 1523 -> 1586 (header default, ADR-0034) -> 1545
                            # (-41, delimitador de polaridade 2026-07-26)
PIN_D17A = 300
PIN_REAL_WORLD_TOTAL = 89430   # 89616 -> 89637 (ADR-0034) -> 89430 (-207, polaridade)
_D1_D9 = [
